...
function Q() {
  ...
  function g(e, t, n) {
    ...
    if (t != null) for (u in t.ref !== void 0 && (s = t.ref), t.key !== void 0 && (c = "" + t.key), t) x.call(t, u) && !O.hasOwnProperty(u) && (o[u] = t[u]);
  ...
  function d(e, t, n, u, o) {
    ...
    if (s) return s = e, o = o(s), e = u === "" ? "." + E(s, 0) : u, j(o) ? (n = "", e != null && (n = e.replace(P, "$&/") + "/"), d(o, t, n, "", function(a) {
      return a;
    })) : o != null && (R(o) && (o = H(o, n + (!o.key || s && s.key === o.key ? "" : ("" + o.key).replace(P, "$&/") + "/") + e)), t.push(o)), 1;
    if (s = 0, u = u === "" ? "." : u + ":", j(e)) for (var f = 0; f < e.length; f++) {
      c = e[f];
      var i = u + E(c, f);
      s += d(c, t, n, i, o);
    }
    else if (i = B(e), typeof i == "function") for (e = i.call(e), f = 0; !(c = e.next()).done; ) c = c.value, i = u + E(c, f++), s += d(c, t, n, i, o);
  ...
  return r.Children = { map: _, forEach: function(e, t, n) {
    ...
    if (t != null) {
      if (t.ref !== void 0 && (c = t.ref, s = S.current), t.key !== void 0 && (o = "" + t.key), e.type && e.type.defaultProps) var f = e.type.defaultProps;
      for (i in t) x.call(t, i) && !O.hasOwnProperty(i) && (u[i] = t[i] === void 0 && f !== void 0 ? f[i] : t[i]);
    }
